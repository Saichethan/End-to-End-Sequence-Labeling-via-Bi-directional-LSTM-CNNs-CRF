...
def load_data():
	...
	x, x_c, y = pad_sequence(sentences, vocb, vocb_char, labelVoc, word_maxlen=30, sent_maxlen=35)
	
	return 	[id_to_vocb,word_matrix,sentences,datasplit,x, x_c, y, num_sentence, vocb, vocb_char, labelVoc]

if __name__ == '__main__':
	load_data()
	id_to_vocb,word_matrix,sentences,datasplit,x, x_c, y, sent_maxlen, word_maxlen, num_sentence, vocb, vocb_char, labelVoc = load_data()
	print x_c[0][0][1]
	print x_c[0][0]
	print x_c[1]
	print y
